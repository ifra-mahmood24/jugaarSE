...
import com.friendlycafe.model.Order;
...
public class StaffThread extends Thread {
    ...
    private int speedFactor = 5; // Default speed (1-10 scale, higher is faster)
    ...
    private long calculateProcessingTime(Order order) {
        ...
        // Base time: 5 seconds + 2 seconds per item
        return 5000 + 2000 * order.getOrderedItems().size();
    }
